...
public class Ex_ListaCircularDuplamenteLigada {
    ...
    public void adicionar(Object item){
        ...
        if(primeiroNo == null){
            novoNo = new NoDuplo(null, null, (NoDuplo) item);
            ...
            novoNo = new NoDuplo(primeiroNo, primeiroNo.getAnteriorNo(), (NoDuplo) item);
            primeiroNo.getAnteriorNo().setProximoNo(novoNo);
     ...
     public void remover(int indice){
        ...
        if((indice % qtdNos) == 0 ){
            ...
            aux = primeiroNo.getAnteriorNo();
            primeiroNo = primeiroNo.getProximoNo();
            primeiroNo.setAnteriorNo(aux);
            qtdNos  -- ;
        }
        else{
